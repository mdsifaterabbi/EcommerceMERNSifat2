                ...
                <div className="navbar-start">
                    ...
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                            <SearchInput />
                            <li><Link className={`${styles.MyLink} px-[10px] py-[5px] my-[3px] uppercase `} to="/">Home Small</Link></li>

                            {
                                !(categories) ? (<><li>Nothing</li></>) : (<>
                                    ...
                                    <div className="dropdown relative">
                                        ...
                                        >
                                            ...
                                            >
                                                <div className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] dropdown dropdown-right`}>
                                                    {/* <div tabIndex={0} role="button" className="">Category</div> */}
                                                    <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                                                        <li><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] my-[1px] uppercase `} to={`/categories`}>All Categories</Link></li>
                                                        {
                                                            categories.map((c) =>
                                                                <li key={c?._id}><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] my-[1px] uppercase `} to={`/category/${c.slug}`}>{c?.name}</Link></li>
                                                            )
                                                        }
                                                    </ul>
                                                </div>
                            ...
                            {
                                !(auth.user) ? (<><li><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] uppercase my-[3px] `} to="/register">Register</Link></li>
                                    <li><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] uppercase my-[3px] `} to="/login">Login</Link></li></>) : (<>
                                        ...
                                        <div className="dropdown relative">
                                            ...
                                            >
                                                ...
                                                >
                                                    <li><Link className={`block px-4 py-2 text-sm hover:bg-orange-400 hover:text-white`} onClick={handleLogout}>Logout</Link></li>
                                                    <li><Link className={`block px-4 py-2 text-sm hover:bg-orange-400 hover:text-white`} to={`/dashboard/${auth?.role === 1 ? "admin" : "user"}`}>Dashboard</Link></li>
                                                </div>
                                            </div>
                            ...
                            <li><Link className={`${styles.MyLink} px-[10px] py-[5px] my-[3px] uppercase `} to="/cart">Cart(0)</Link></li>
                        </ul>
                    </div>
                    <Link className="btn btn-ghost text-xl" to="/"><FaShoppingBag /> Shop on Desire</Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <SearchInput />
                    <ul className="menu menu-horizontal px-1">
                        <li><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] uppercase `} to="/">Home Big</Link></li>
                        <div className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] dropdown dropdown-bottom`}>
                            <div tabIndex={0} role="button" className="">Category</div>
                            <ul tabIndex={0} className="dropdown-content z-[1] menu  shadow bg-base-100 rounded-box w-52">
                                <li><Link className={`${styles.MyLink} px-[10px]  mx-[3px] my-[1px] uppercase `} to={`/categories`}>All Categories</Link></li>
                                {
                                    categories.map((c) =>
                                        <li key={c?._id}><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] my-[1px] uppercase `} to={`/category/${c.slug}`}>{c?.name}</Link></li>
                                    )
                        ...
                        {
                            !(auth.user) ? (<><li><Link className={`${styles.MyLink} px-[10px] py-[5px] mx-[3px] uppercase `} to="/register">Register</Link></li>
                        ...
                        <li>
                            <Link className={`px-[10px] py-[5px] mx-[3px] uppercase `} to="/cart">
                                {/* Cart({cart?.length}) */}
